...
private let keepAliveLog = Logger(subsystem: "io.github.top1ashier.readest", category: "TTSKeepAlive")
...
class NativeTTSPlugin: Plugin, AVSpeechSynthesizerDelegate {
  ...
  private let playoutAnalysisQueue = DispatchQueue(label: "io.github.top1ashier.readest.tts.playout")
