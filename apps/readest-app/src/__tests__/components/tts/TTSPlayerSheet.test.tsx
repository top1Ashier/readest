...
describe('TTSPlayerSheet', () => {
  ...
  test('offline audio row: a free user has direct access in the community build', () => {
  ...
  test('offline audio row: a signed-out user has direct access in the community build', () => {
    mockAuth.user = null;
